...
I may forget about some but mostly:
 ...
 - All these vim plugins submoduled with git (for updates):
    ...
    Syntax
    ------
    - css3syntaxcolor - http://www.vim.org/scripts/script.php?script_id=3042
    - csscolor - http://www.vim.org/scripts/script.php?script_id=2150
    - djangosyntaxcolor - http://www.vim.org/scripts/script.php?script_id=1487
    - docssyntaxcolor - http://www.vim.org/scripts/script.php?script_id=262
    - doctestsyntaxcolor - http://www.vim.org/scripts/script.php?script_id=1867
    - gitsyntaxcolor - From Armin Ronacher dotfiles
    - gnuplot - http://www.vim.org/scripts/script.php?script_id=1737
    - html5color - http://www.vim.org/scripts/script.php?script_id=3232
    - jinjasyntaxcolor - http://www.vim.org/scripts/script.php?script_id=1856
    - jquerycolor - http://www.vim.org/scripts/script.php?script_id=2416
    - jsoncolor - http://www.vim.org/scripts/script.php?script_id=1945
    - muttrc - http://www.vim.org/scripts/script.php?script_id=1479
    - pythoncoverage - http://www.vim.org/scripts/script.php?script_id=2643
    - pythonsyntaxcolor - http://www.vim.org/scripts/script.php?script_id=790
    - restsyntaxcolor - http://www.vim.org/scripts/script.php?script_id=973
    - tumblr - http://www.vim.org/scripts/script.php?script_id=3011
    - txtsyntaxcolor - http://www.vim.org/scripts/script.php?script_id=1532
    - wikipedia - http://www.vim.org/scripts/script.php?script_id=1787
